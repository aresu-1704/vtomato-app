...
class DiseaseHistoryService:
    ...
    def SaveHistory(self, UserID=-1, ImageByte = None, ClassIdxList = []):
        ...
        self.disease_history_model.SaveDiseaseHistory(UserID, relative_img_path, ClassIdxList)

        return "Save successfully"

    def GetPredictHictoryByID(self, ID=-1):
